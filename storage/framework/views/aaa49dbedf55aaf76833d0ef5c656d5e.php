...
<?php $__env->startSection('desc', 'Halaman Dashboard'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('user')): ?>
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card h-100 shadow-sm border-0 overflow-hidden">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mb-2">
                                    <?php echo $laporan->status_label ?? '<span class="badge bg-secondary">Tidak diketahui</span>'; ?>
                            ...
                            <div class="card-footer bg-white border-0 pt-0">
                                ...
                                <?php if(!$sudah): ?>
                                    <button type="button" class="btn btn-success w-100" 
                                            data-toggle="modal" data-target="#klaimModal<?php echo e($laporan->id); ?>">
                                        🎯 Ajukan Klaim
                                    </button>
                                <?php else: ?>
        ...
        <?php if($userRole === 'user' && $userLaporans->count() > 0): ?>
            ...
            <div class="row">
                <?php $__empty_1 = true; $__currentLoopData = $userLaporans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-md-6 col-lg-4 col-xl-3 mb-4">
                        <div class="card h-100 shadow-sm border-0 overflow-hidden">
                            ...
                            <div class="card-footer bg-white border-0 pt-0">
                                <a href="<?php echo e(route('laporan.edit', $laporan)); ?>" class="btn btn-warning btn-sm w-100">
                                    ✏️ Edit Laporan
                                </a>
                            </div>
                        </div>
        ...
        <?php if($userRole === 'user' && $laporans->count() === 0 && $userLaporans->count() === 0): ?>
            <div class="col-12 text-center py-5">
                <i class="fas fa-home fa-3x text-muted mb-3"></i>
                <h5>Selamat Datang! 🎉</h5>
                <p class="text-muted">Mulai dengan membuat laporan barang temuan atau lihat barang yang bisa diklaim.</p>
                <div class="mt-3">
                    <a href="<?php echo e(route('laporan.create')); ?>" class="btn btn-primary me-2">📝 Buat Laporan</a>
                    <a href="<?php echo e(route('pages.laporan.index')); ?>" class="btn btn-outline-primary">🔍 Lihat Barang</a>
                </div>
            </div>
        <?php endif; ?>
            ...
            <?php $__currentLoopData = $laporans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $laporan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php if(!$sudah): ?>
                    ...
                    <div class="modal fade" 
                         id="klaimModal<?php echo e($laporan->id); ?>" 
                         tabindex="-1" 
                         role="dialog" 
                         aria-labelledby="klaimModalLabel<?php echo e($laporan->id); ?>" 
                         aria-hidden="true"
                         data-backdrop="false"
                         data-keyboard="true"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="klaimModalLabel<?php echo e($laporan->id); ?>">
                                        Ajukan Klaim - <?php echo e($laporan->nama_barang); ?>
                                ...
                                <form action="<?php echo e(route('klaim.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\website\ufounds\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>